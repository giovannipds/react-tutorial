...
**Note:** *since this repo is just for study, security warnings were going to be **disabled** to this project and it will have some security issues that would be resolved if dependencies are updated. Remember to re-enable security warnings if needed when cloning this repo.*
